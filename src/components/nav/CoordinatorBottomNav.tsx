...
export default function CoordinatorBottomNav() {
  ...
  return (
    <div className="bottom-nav">
      <Link href="/coordinator" aria-label="Campaigns" aria-current={isCampaigns ? 'page' : undefined} style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, color: isCampaigns ? 'var(--teal)' : 'var(--text-muted)' }}>
      ...
      <Link href="/coordinator/analytics" aria-label="Analytics" aria-current={isAnalytics ? 'page' : undefined} style={{ textDecoration: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 4, color: isAnalytics ? 'var(--teal)' : 'var(--text-muted)' }}>
